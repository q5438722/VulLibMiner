...
if [ "$1" = "amazon670k" ]; then
    ...
    echo start $1
    python src/main.py --lr 1e-4 --epoch 20 --dataset cve_data --swa --swa_warmup 10 --swa_step 200 --batch 8  --valid
    python src/main.py --lr 1e-4 --epoch 20 --dataset cve_data --swa --swa_warmup 10 --swa_step 200 --batch 8  --bert roberta --valid
    python src/main.py --lr 1e-4 --epoch 20 --dataset cve_data --swa --swa_warmup 10 --swa_step 400 --batch 4 --update_count 2 --bert xlnet --valid
