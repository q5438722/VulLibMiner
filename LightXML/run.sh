...
if [ "$1" = "amazon670k" ]; then
    ...
    echo start $1
    python src/main.py --lr 1e-4 --epoch 20 --dataset cve_data --swa --swa_warmup 10 --swa_step 200 --batch 8  
    python src/main.py --lr 1e-4 --epoch 20 --dataset cve_data --swa --swa_warmup 10 --swa_step 200 --batch 8  --bert roberta
    python src/main.py --lr 1e-4 --epoch 20 --dataset cve_data --swa --swa_warmup 10 --swa_step 400 --batch 4 --update_count 2 --bert xlnet
    # python src/main.py --lr 1e-4 --epoch 20 --dataset cve_data --swa --swa_warmup 10 --swa_step 200 --batch 8  --bert docbert
    # python src/main.py --lr 1e-4 --epoch 20 --dataset cve_data --swa --swa_warmup 10 --swa_step 200 --batch 8  --bert bigbird
    # python src/main.py --lr 1e-4 --epoch 20 --dataset cve_data --swa --swa_warmup 10 --swa_step 200 --batch 4  --bert longformer

    python src/ensemble.py --dataset vul_lib --cp models
elif [ "$1" = "vul_lib" ]; then
    echo start $1
    python src/main.py --lr 1e-4 --epoch 30 --dataset vul_lib --swa --swa_warmup 10 --swa_step 200 --batch 8  
    python src/main.py --lr 1e-4 --epoch 30 --dataset vul_lib --swa --swa_warmup 10 --swa_step 200 --batch 8  --bert roberta
    python src/main.py --lr 1e-4 --epoch 30 --dataset vul_lib --swa --swa_warmup 10 --swa_step 400 --batch 4 --update_count 2 --bert xlnet
    # python src/main.py --lr 1e-4 --epoch 20 --dataset cve_data --swa --swa_warmup 10 --swa_step 200 --batch 8  --bert docbert
    # python src/main.py --lr 1e-4 --epoch 20 --dataset cve_data --swa --swa_warmup 10 --swa_step 200 --batch 8  --bert bigbird
    # python src/main.py --lr 1e-4 --epoch 20 --dataset cve_data --swa --swa_warmup 10 --swa_step 200 --batch 4  --bert longformer

    python src/ensemble.py --dataset vul_lib --cp models
elif [ "$1" = "cve_java" ]; then
    echo start $1
    python src/main.py --lr 1e-4 --epoch 30 --dataset cve_java --swa --swa_warmup 10 --swa_step 200 --batch 8  
    python src/main.py --lr 1e-4 --epoch 30 --dataset cve_java --swa --swa_warmup 10 --swa_step 200 --batch 8  --bert roberta
    python src/main.py --lr 1e-4 --epoch 30 --dataset cve_java --swa --swa_warmup 10 --swa_step 400 --batch 4 --update_count 2 --bert xlnet
    # python src/main.py --lr 1e-4 --epoch 20 --dataset cve_data --swa --swa_warmup 10 --swa_step 200 --batch 8  --bert docbert
    # python src/main.py --lr 1e-4 --epoch 20 --dataset cve_data --swa --swa_warmup 10 --swa_step 200 --batch 8  --bert bigbird
    # python src/main.py --lr 1e-4 --epoch 20 --dataset cve_data --swa --swa_warmup 10 --swa_step 200 --batch 4  --bert longformer

    python src/ensemble.py --dataset cve_java --cp models
fi